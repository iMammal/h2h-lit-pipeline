# Revised STAR Title/Abstract Screening - Stage 5C Pre-production

Prompt-Version: 1.2.0
Protocol-Version: 1.0.0
Rubric-Version: 1.0.0
Stage: title_abstract
Output-Schema-Version: 1.2.0
...
Every `PRESENT` or `UNCERTAIN` annotation requires label-specific supportive evidence.
`ABSENT` may use an empty evidence list but still requires a rationale. A quotation may
support more than one decision only when that same passage substantively establishes each
of those decisions. Do not reuse it merely because it is an exact substring or because
the JSON schema requires evidence. For `Immersive`, a mention of VR, AR/MR, HoloLens, or
an immersive display establishes modality only unless the passage also supports
computational assistance exploiting an immersive-environment property.
...
include E6, aggregate eligibility, primary/secondary exclusion reasons, or any other
derived outcome. Each classification array must contain every frozen label exactly once.
...
```json
{
  ...
  "assistance_modes": [
    {"label": "Algorithmic", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Adaptive", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Conversational", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Immersive", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."}
  ],
  "visualization_modalities": [
    {"label": "Desktop 2D", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Large Display", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "VR", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "AR/MR", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "CAVE", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."}
  ],
  "tasks": [
    {"label": "Navigation and Multiscale Orientation", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Comparison and Differentiation", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Selection, Filtering, and Precision Interaction", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Sensemaking and Hypothesis Development", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."},
    {"label": "Coordination and Collaborative Reasoning", "state": "PRESENT|ABSENT|UNCERTAIN", "certainty": "SUPPORTED|UNCERTAIN", "evidence": [], "rationale": "..."}
  ],
  "overall_rationale": "..."
}
```
